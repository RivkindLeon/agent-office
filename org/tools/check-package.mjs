// Автоматическая часть приёмки пакета должности (org/HIRING.md).
...
// 5. версия и история версий
check(5, "в PROFILE.md есть версия X.Y и история версий",
  /Версия пакета:\s*\d+\.\d+/i.test(profile) && /##\s*История/i.test(profile));

// 6. оба раздела критериев
check(6, "в ACCEPTANCE.md есть разделы «Автоматические» и «Оценочные»",
  /##\s*Автоматическ/i.test(accept) && /##\s*Оценочн/i.test(accept));
