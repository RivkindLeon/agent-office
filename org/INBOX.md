...
Собрано: 2026-09-03 11:02 UTC

1. **head-of-product** работает по непроверенной версии 4.0 — нет вердикта «по форме»
   — прочитать пакет целиком и положить вердикт: сотрудник уже работает по этой инструкции
   — `roles/head-of-product/`

2. **head-of-product** работает по непроверенной версии 4.0 — нет вердикта «по существу»
   — прочитать пакет целиком и положить вердикт: сотрудник уже работает по этой инструкции
   — `roles/head-of-product/`
