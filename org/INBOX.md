...
4. **head-of-people** работает по непроверенной версии 12.0 — нет вердикта «по форме»
   — прочитать пакет целиком и положить вердикт: сотрудник уже работает по этой инструкции
   — `roles/head-of-people/`

5. **head-of-people** работает по непроверенной версии 12.0 — нет вердикта «по существу»
   — прочитать пакет целиком и положить вердикт: сотрудник уже работает по этой инструкции
   — `roles/head-of-people/`
