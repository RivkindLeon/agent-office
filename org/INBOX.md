...
2. пакет **head-of-engineering 2.0** ждёт ревью **по форме**
   — пройти org/PACKAGE-ACCEPTANCE.md и положить вердикт с `dimension: form`
   — `roles/head-of-engineering/`

3. пакет **head-of-engineering 2.0** ждёт ревью **по существу** (заказчик: founder)
